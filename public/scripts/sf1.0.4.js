 ...
 */
define(
  ['jquery', 'eventbus', 'i18n', 'marionette', 'text!scripts/sf1.config.json', 'cookie'],
  function ($, EventBus, i18n,  Marionette, config) {
    var sf1 = {};
...
//                + sup + "</SUP> " + m_names[curr_month] + " " + curr_year);
    ...
    sf1.getI18nLabel = function(){
      if (arguments.length > 0){
        return i18n.t(arguments[0],arguments[1]) || key;

      }
      else{
        return i18n.t(arguments[0]) || key;
      }
    };
